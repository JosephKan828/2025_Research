...
# Load data
## file name
fname :: String = "/work/b11209013/2024_Research/nstcCCKW/Q1/Q1Flt.nc";
...
q1 :: Array{Float32, 4} = ds["Q1"][:, :, :, str_idx:end_idx] * (86400 / 1004.5);
...
ga = GeoAxis(fig[1, 1];
             aspect=AxisAspect(7.5), dest="+proj=merc +lon_0=180", title="Q1 variance map", xgridcolor=:black,
...
Colorbar(fig[2, 1], cont; label="Q1 variance (m2/s2)", vertical=false, width=Relative(1.0))
# Save the figure
save("q1_var_vint.png", fig)
